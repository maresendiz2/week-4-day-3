...
##############################################################################################################
# basic review
# Find and display on the screen which character occupies the fifth position 
#within the following word:
# computer = "computer"
# print(computer[-1])
...
# transportation_means.insert(2,"bugatti")
# print(transportation_means)
...
# luckyNumbers.append("me")
# luckyNumbers.append("myself")
